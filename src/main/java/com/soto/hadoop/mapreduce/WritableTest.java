package com.soto.hadoop.mapreduce;
...
public class WritableTest {
    ...
    public static void main(String[] args) {
        ...
        a.set(new IntWritable[]{
                new IntWritable(1),new IntWritable(3),new IntWritable(5)
        });
        ...
        ia.set(new IntWritable[]{
                new IntWritable(1), new IntWritable(3), new IntWritable(5)
        });

        IntWritable[] ivalues = (IntWritable[]) ia.get();
        ia.set(new LongWritable[]{
                new LongWritable(10001)
        });
